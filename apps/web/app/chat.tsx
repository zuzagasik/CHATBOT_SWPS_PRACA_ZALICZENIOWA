...
export default function Chat() {
  ...
  async function sendMessage(e: React.FormEvent) {
    ...
    try {
      ...
      if (!res.ok) {
        throw new Error(`Żądanie nie powiodło się (${res.status})`);
      }
      if (!res.body) {
      ...
      // Dodajemy pustą wiadomość bota, którą będziemy uzupełniać na żywo.
      ...
      while (true) {
        ...
        setMessages((prev) => {
          ...
          if (last) {
            // Nowy obiekt zamiast mutacji — inaczej React StrictMode
            // (tryb deweloperski) dokleja każdy chunk dwukrotnie.
